...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tv5q7se.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tv5q7se.containers.anotherwebservice.com/
...
```
git clone git@github.com:akhyariz/container-tv5q7se.git
cd container-tv5q7se
```
...
```
docker attach container-tv5q7se
```
